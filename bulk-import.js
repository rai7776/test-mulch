    ...
    function createBulkModal() {
        ...
        overlay.innerHTML = `
            <div class="modal-content bulk-import-modal" role="dialog" aria-modal="true" aria-labelledby="bulk-import-title">
                ...
                <p class="bulk-import-help">プロンプトには、現在の章の本文と「Smart Reader Bulk Import v2」の出力サンプルJSONが含まれます。AIの返答は <code>JSONコードブロック</code> ごと貼り付けてOKです。</p>
