...
marker = "    function installEditor() {\n"
helper = r'''    function extractAiJsonCandidate(raw) {
...
'''
if marker not in s:
    raise SystemExit('installEditor marker not found')
s = s.replace(marker, helper + marker, 1)

old_actions = '''                    <div class="note-structure-editor-actions" aria-label="文構造を追加">
...
new_actions = '''                    <div class="note-structure-editor-actions" aria-label="文構造を追加">
                        <button type="button" data-add-core="S">＋S</button>
                        <button type="button" data-add-core="V">＋V</button>
                        <button type="button" data-add-core="O">＋O</button>
                        <button type="button" data-add-core="C">＋C</button>
...
s = p.read_text(encoding='utf-8')
old = "loadScript('note-structure-editor.js?v=2', 'note-structure-editor-loader');"
new = "loadScript('note-structure-editor.js?v=3', 'note-structure-editor-loader');"
if old not in s:
...
p = Path('index.html')
s = p.read_text(encoding='utf-8')
old = 'note-structure-ui.js?v=2.0'
new = 'note-structure-ui.js?v=2.1'
if old not in s:
